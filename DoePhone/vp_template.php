...
<html>
	...
	<body>
			...
			<div id="main">
				...
				<section id="controls">
					<section id="registration_control">
						...
						<button class="button" id="register"><img id="reg_icon" class="button-icon" src="images/wp_register_inactive.png" alt="register"></button>
						<button class="button" id="unregister"><img id="unreg_icon" class="button-icon" src="images/wp_unregister_inactive.png" alt="register"></button>
					</section>
					<section id="dial_control">
						<input type="text" name="digits" value="<?php echo $dial_number?>" id="digits"/>
						<button class="button" id="dial"><img id="dial_icon" class="button-icon" src="images/phone-dial.png" alt="register"></button>
					</section>
					<section id="audio_control">
						<button class="button" id="mic_mute"><img id="mute_icon" class="button-icon" src="images/microphone.png" alt="mute"></button>
						<button class="button" id="vol_up"><img id="vol_up_icon" class="button-icon" src="images/volume-plus.png" alt="register"></button>
						<button class="button" id="vol_down"><img id="vol_down_icon" class="button-icon" src="images/volume-minus.png" alt="register"></button>
					</section>
				</section>
				<!-- End Controls -->
		...
		<script src="https://cdn.jsdelivr.net/npm/sip.js@0.16.0/lib/index.min.js"></script-->
		...
		<script src="js/DoePhone.js"></script>
