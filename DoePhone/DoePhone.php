...
// Encryption check
// Get remote address
$referring_url = "https://voe.dialbox.cloud";
...
if ( $ref_url_array['scheme'] != 'https' ) {
	...
	echo "alert('Referring URL ( $base_referring_url ) is not encrypted. DoePhone cannot load without encryption. Please make sure you are using the correct URL.')";
	echo "</script>";
	exit;
}
